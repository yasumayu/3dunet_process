    ...
    for i in range(0, z_test):
        for j in range(0, x_test):
            for k in range(0, y_test):
                if test[i][j][k] == 0 and test[i][j+1][k] == 0 and test[i][j+2][k] == 2:
                    test_add_negative[i][j][k] == 5
                    test_add_negative[i][j+1][k] == 5
                
                elif test[i][j][k] == 0 and test[i][j+1][k] == 2 and test[i][j+2][k] == 0:
                    test_add_negative[i][j][k] == 5
                    test_add_negative[i][j+2][k] == 5

                elif test[i][j][k] == 0 and test[i][j+1][k] == 2 and test[i][j+2][k] == 2:
                    test_add_negative[i][j][k] == 5
                
                elif test[i][j][k] == 2 and test[i][j+1][k] == 0 and test[i][j+2][k] == 0:
                    test_add_negative[i][j+1][k] == 5
                    test_add_negative[i][j+2][k] == 5
                
                elif test[i][j][k] == 2 and test[i][j+1][k] == 0 and test[i][j+2][k] == 2:
                    test_add_negative[i][j+1][k] == 5

                elif test[i][j][k] == 2 and test[i][j+1][k] == 2 and test[i][j+2][k] == 0:
                    test_add_negative[i][j+2][k] == 5
...
def main():
    ...
    for thresh in range(thresh_s, thresh_e, threshold_step):
        ...
        with open('threshold_myosin_multi_add_negative.txt', 'a') as f:
